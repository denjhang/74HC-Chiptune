...
RTL="rtl/wt3_top.v rtl/wt_spfm_bus.v rtl/hc39sf040.v rtl/hc62256.v rtl/hc161.v rtl/hc157.v rtl/hc377.v rtl/hc283.v rtl/hc74.v rtl/hc04.v rtl/hc273.v rtl/hc138.v rtl/hc174.v"

echo "=== Compiling ${TB} ==="
# iverilog MUST run via cmd.exe — MSYS2 bash popen() breaks the ivlpp|ivl pipe
/c/Windows/System32/cmd.exe //c "set PATH=D:\oss-cad\bin;D:\msys64\mingw64\bin;%PATH%&& iverilog -o wt3_debug.vvp -Wall ${RTL} tb/${TB}.v" 2>&1
echo "Compile RC=$?"

echo "=== Simulating ==="
"$VVP" wt3_debug.vvp 2>&1
echo "Sim RC=$?"
