...
module wt3_spfm_bus (
    ...
    // 调试输出 (默认关闭, 测试时用 +define+SPFM_DEBUG 打开)
`ifdef SPFM_DEBUG
    always @(posedge CLK) begin
        $display("Time=%0t: addr_wr_comb=%b, addr_q1=%b, addr_q2=%b, addr_q3=%b, addr_wr_pulse_n=%b",
                 $time, addr_wr_comb, addr_q1, addr_q2, addr_q3, addr_wr_pulse_n);
    end
`endif
