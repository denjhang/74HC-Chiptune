...
module wt3_core_tb;
    ...
    initial begin
        ...
        // 频率计算: f = step × 96000 / 65536 (16-bit 相位)
        // A440 = 440 × 65536 / 96000 = 300.4 ≈ 0x012C
        // C4 = 261.63 × 65536 / 96000 = 178.5 ≈ 0x00B2
        // E4 = 329.63 × 65536 / 96000 = 225.0 ≈ 0x00E1
        // G4 = 392.00 × 65536 / 96000 = 267.3 ≈ 0x010B
        // C5 = 523.25 × 65536 / 96000 = 357.0 ≈ 0x0165
        set_note(2'd0, 8'hB2, 8'h00, 4'h0);  // C4, vol=0
        set_note(2'd1, 8'hE1, 8'h00, 4'h0);  // E4, vol=0
        set_note(2'd2, 8'h0B, 8'h01, 4'h0);  // G4, vol=0
        set_note(2'd3, 8'h65, 8'h01, 4'h0);  // C5, vol=0
