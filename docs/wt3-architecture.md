...
## 9. 芯片清单 (v1.4: 30 IC, 0 隐藏门)

| 类别 | v1.3 | v1.4 | 变化 |
|------|------|------|------|
| SPFM 总线 | 3 (373+174+377) | **4** (+1 显式 hc04 反相 wr_pulse) | **+1 IC** |
| 数据寄存器 | 3 (377×3) | **5** (377×5) | **+2 IC** (reg_a_hi, reg_b_hi) |
| Step 计数器 | 2 (161×2) | 2 | - |
| 微码 ROM | 1 (39SF040) | 1 (8-bit) | - |
| Wavetable ROM | 1 (39SF040) | 1 | - |
| 地址/DI/WE mux | 5 (157×5) | **7** (157×7) | **+2 IC** (wb_mux + wb_mux_hi) |
| 译码器 | 0 | **1** (154) | **+1 IC** |
| 反相器 | 0 (隐藏) | **2** (04×2) | **+2 IC** |
| 与门 | 0 (隐藏) | **1** (08) | **+1 IC** (tc_lo & RST_n) |
| 或门 | 0 (隐藏) | **1** (32) | **+1 IC** (decode_disable) |
| 参数 RAM | 1 (62256) | 1 | - |
